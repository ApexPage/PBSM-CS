Feature CFE Process Screen	NON-MAT-FIX_TC001
Scenario	Behavior Pattern Non-Maturity for Fixed rate AOD-MD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_MATURITYDATE
DataFilter:  BP_NM_FIX_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC002
Scenario	Behavior Pattern Non-Maturity for Fixed rate AOD-MD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_MATURITYDATE
...
Feature CFE Process Screen	NON-MAT-FIX_TC003
Scenario	Behavior Pattern Non-Maturity for Fixed rate AOD-MD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_MATURITYDATE
DataFilter:  CONV_FIX_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC004
Scenario	Behavior Pattern Non-Maturity for Fixed rate OD-MD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
...
Feature CFE Process Screen	NON-MAT-FIX_TC005
Scenario	Behavior Pattern Non-Maturity for Fixed rate OD-MD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ORGDATE_TO_MATURITYDATE
DataFilter:  CONV_FIX_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC006
Scenario	Behavior Pattern Non-Maturity for Fixed rate OD-MD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ORGDATE_TO_MATURITYDATE
DataFilter:  CONV_FIX_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC007
Scenario	Behavior Pattern Non-Maturity for Fixed rate GROSS & AOD-MD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_MATURITYDATE
DataFilter:  CONV_FIX_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC008
Scenario	Behavior Pattern Non-Maturity for Fixed rate GROSS & AOD-MD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_MATURITYDATE
DataFilter:  CONV_FIX_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC009
Scenario	Behavior Pattern Non-Maturity for Fixed rate GROSS & AOD-MD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_MATURITYDATE
DataFilter:  CONV_FIX_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC010
Scenario	Behavior Pattern Non-Maturity for Fixed rate GROSS & OD-MD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ORGDATE_TO_MATURITYDATE
DataFilter:  CONV_FIX_PAY
Model with Gross rate : GROSS
...
Feature CFE Process Screen	NON-MAT-FIX_TC011
Scenario	Behavior Pattern Non-Maturity for Fixed rate GROSS & OD-MD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ORGDATE_TO_MATURITYDATE
DataFilter:  CONV_FIX_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC012
Scenario	Behavior Pattern Non-Maturity for Fixed rate GROSS & OD-MD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ORGDATE_TO_MATURITYDATE
DataFilter:  CONV_FIX_PAY
...
User Story	Testing Json based input and output -  Behavior Pattern Non-Maturity (Adjustable Interest Rate, No Prepayment)
	
Feature CFE Process Screen	NON-MAT-FIX_TC013
Scenario	Behavior Pattern Non-Maturity for Adjustable rate LRD-NRD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
...
Feature CFE Process Screen	NON-MAT-FIX_TC014
Scenario	Behavior Pattern Non-Maturity for Adjustable rate LRD-NRD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: LASTREPRICEDATE_TO_NEXTREPRICEDATE
DataFilter:  CONV_ADJ_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC015
Scenario	Behavior Pattern Non-Maturity for Adjustable rate LRD-NRD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: LASTREPRICEDATE_TO_NEXTREPRICEDATE
DataFilter:  CONV_ADJ_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC016
Scenario	Behavior Pattern Non-Maturity for Adjustable Rate AOD-NRD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
...
Feature CFE Process Screen	NON-MAT-FIX_TC017
Scenario	Behavior Pattern Non-Maturity for Adjustable Rate AOD-NRD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_NEXTREPRICEDATE
DataFilter:  CONV_ADJ_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC018
Scenario	Behavior Pattern Non-Maturity for Adjustable Rate AOD-NRD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_NEXTREPRICEDATE
DataFilter:  CONV_ADJ_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC019
Scenario	Behavior Pattern Non-Maturity for Adjustable rate GROSS & LRD-NRD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: LASTREPRICEDATE_TO_NEXTREPRICEDATE
DataFilter:  CONV_ADJ_PAY
Model with Gross rate : GROSS
...
Feature CFE Process Screen	NON-MAT-FIX_TC020
Scenario	Behavior Pattern Non-Maturity for Adjustable rate GROSS & LRD-NRD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: LASTREPRICEDATE_TO_NEXTREPRICEDATE
DataFilter:  CONV_ADJ_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC021
Scenario	Behavior Pattern Non-Maturity for Adjustable rate GROSS & LRD-NRD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: LASTREPRICEDATE_TO_NEXTREPRICEDATE
DataFilter:  CONV_ADJ_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC022
Scenario	Behavior Pattern Non-Maturity for Fixed rate GROSS & AOD-NRD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_NEXTREPRICEDATE
DataFilter:  CONV_ADJ_PAY
Model with Gross rate : GROSS
...
Feature CFE Process Screen	NON-MAT-FIX_TC023
Scenario	Behavior Pattern Non-Maturity for Fixed rate GROSS & AOD-NRD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_NEXTREPRICEDATE
DataFilter:  CONV_ADJ_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC024
Scenario	Behavior Pattern Non-Maturity for Fixed rate GROSS & AOD-NRD @Functional - Positive
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_NEXTREPRICEDATE
DataFilter:  CONV_ADJ_PAY
...
Feature CFE Process Screen	NON-MAT-FIX_TC025
Scenario	Behavior Pattern Non-Maturity for Reprice Dates @API- Negative
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_NEXTREPRICEDATE
DataFilter:  CONV_ADJ_PAY
Model with Gross rate : NET
...
Feature CFE Process Screen	NON-MAT-FIX_TC026
Scenario	Behavior Pattern Non-Maturity for missing Last Reprice Date Balance @API- Negative
Given	End point url (/v1/generateCashFlows) and necessary parameters are passed as below
Date Range: ASOFDATE_TO_NEXTREPRICEDATE
DataFilter:  CONV_ADJ_PAY
Model with Gross rate : NET
...
User Story	Testing Json based input and output -  Non Amortizing Payment (Fixed Interest Rate, No Prepayment)
...
User Story	Testing Json based input and output -  Non Amortizing Payment (Adjustable Rate, No Prepayment)
...
User Story	Testing Json based input and output -  Non Amortizing Payment (Fixed Interest Rate, No Prepayment, Interest Capitalization)
...
User Story	Testing Json based input and output -  Level Principal Payment (Fixed Interest Rate, No Prepayment)
...
User Story	Testing Json based input and output -  Level Principal Payment (Adjustable Interest Rate, No Prepayment)
...
User Story	Testing Json based input and output -  Balloon Payment (Fixed Rate, No Prepayment)
...
User Story	Testing Json based input and output -  Balloon Payment (Adjustable Interest Rate, No Prepayment)
...
User Story	Testing Json based input and output -  Annuity Payment (Fixed Rate, No Prepayment)
...
User Story	Testing Json based input and output -  Annuity Payment (Adjustable Interest Rate, No Prepayment)
...
User Story	Testing Json based input and output -  Lease Payment (Fixed Rate, No Prepayment)
...
User Story	Testing Json based input and output -  Lease Payment (Adjustable Interest Rate, No Prepayment)
