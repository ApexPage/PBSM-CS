Feature CFE Process Screen	CONV_NONSCH_PRPY_TC001
...
User Story	Testing Json based input and output -  Conventional Payment (Adjustable Interest Rate, With  Prepayment)
